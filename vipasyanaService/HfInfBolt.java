...
public class HfInfBolt extends ShellBolt implements IRichBolt {
    public HfInfBolt() {
        /*
         ...
         * 
         * The reason executing hfonlyStart.sh is that we can't execute 
         ...
         */
        super("/usr/hfgpuStart.sh", "./hfonly/hfInfServerBolt.py");
    }
    @Override
